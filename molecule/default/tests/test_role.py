...
@pytest.mark.parametrize('username,groupname,path,key', [
...
@pytest.mark.parametrize('username,groupname,path,name', [
...
@pytest.mark.parametrize('username,groupname,path,mode,key', [
